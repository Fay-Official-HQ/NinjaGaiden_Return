extends CanvasLayer
class_name BossDeathDirector_3
...
func _capture_freeze_frame(boss: Boss3) -> void:
...
func _disable_attack_hitboxes(boss: Boss3) -> void:
...
func _safe_freeze_before_capture(boss: Boss3) -> void:
	boss.is_dead = true
...
func play_death_sequence(boss: Boss3) -> void:
	if _is_playing:
		return
	_is_playing = true
	BossDeathDirector_3.is_death_playing = true
...
func _phase_recover() -> void:
	...
	_boss.state_machine.change_state_by_name("Boss3DeathState", {"director": self})
...
func _end_level() -> void:
	_is_playing = false
	BossDeathDirector_3.is_death_playing = false
